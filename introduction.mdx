...
Refer to [Get Started](/payment-api#get-started) guidance in the Payments API folder.

## **D. Use Data API**

Refer to [Get Started](/data-api#get-started) guidance in the Data API folder.
