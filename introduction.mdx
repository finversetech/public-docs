...
Refer to [Get Started](https://finverse.mintlify.app/payment-api#get-started) guidance in the Payments API folder.

## **D. Use Data API**

Refer to [Get Started](https://finverse.mintlify.app/data-api#get-started) guidance in the Data API folder.
